export const authors = [
  "John Ray", "Wayne Gretzky", "Friedrich Nietzsche", "Ella Wheeler Wilcox", "Abraham Lincoln", "Audrey Hepburn", "Horace Mann", "Carol Burnett", "Erma Bombeck", "Patrick Henry", "Dolly Parton", "Mother Teresa", "Michelangelo", "Oprah Winfrey", "Charlie Chaplin", "Dale Carnegie", "George Bernard Shaw", "Amelia Earhart", "Elie Wiesel", "Alexandria Ocasio-Cortez", "Queen Elizabeth II", "George Washington", "Benjamin Franklin", "Muhammad Ali", "J.R.R. Tolkien", "Pablo Picasso", "Toni Morrison", "Leonardo Da Vinci",
  "Albert Einstein", "Joe Namath", "Dr. Seuss", "Dalai Lama", "Eckhart Tolle", "Indira Gandhi", "Heraclitus", "Walt Disney", "Mark Twain", "Oscar Wilde", "Isaac Newton", "Nelson Mandela", "Jean-Jacques Rousseau", "George Washington", "David Bowie", "Princess Diana", "Charlie Chaplin", "Norman Vincent Peale", "Liza Minelli", "Socrates", "Eleanor Roosevelt", "Malcolm X", "Mahatma Gandhi", "Henry D Thoreau", "Hugh Blair", "Muhammad Ali", "Albert Camus", "Ernest Hemingway", "Fyodor Dostoevsky", "Bruce Lee",
  ...
  "Lilian GIsh", "Lucretius", "Mahatma Gandhi", "Tom Heehler", "Martha Graham", "Francis Ford Coppola/Mario Puzo", "Maya Angelou", "Napoleon Hill", "Malala Yousafzai", "Lucretius", "John McCrae", "Maxim Gorky", "Ralph Waldo Emerson", "Alexander Pope", "Voltaire", "George Santayana",
